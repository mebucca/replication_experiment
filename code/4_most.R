...
depvar <- c("most_talent","most_luck","most_rules")
 
label <- c("P(talent most important)","P(luck most important)","P(rules most important)")
...
for (dv in depvar) {
  ...
  myplot <- newx %>%
    ...
    theme(legend.position = "bottom") + ylim(0,0.9) +
    labs(colour = "inequality of outcomes", x = "inequality of opportunity", 
